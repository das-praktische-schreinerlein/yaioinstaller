...
s/^ *<exec executable="cmd.exe"><arg value="\/C" \/><arg value="\$\{basedir\}\/sbin\/start-yaioapp-test.bat" \/><\/exec>.*/                                <exec executable="\/bin\/bash"><arg value="${basedir}\/sbin\/start-yaioapp-test.sh" \/><\/exec>/
s/^ *<exec executable="cmd.exe"><arg value="\/C" \/><arg value="\$\{basedir\}\/sbin\/stop-yaioapp.bat" \/><\/exec>.*/                                <exec executable="\/bin\/bash"><arg value="${basedir}\/sbin\/stop-yaioapp.sh" \/><\/exec>/
